...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'year' => 'ระดับชั้น',
        'prefix' => 'คำนำหน้าชื่อ',
        't1-s1-firstName' => 'ชื่อ',
        't1-s1-lastName' => 'นามสกุล',
        't1-s1-year' => 'ระดับชั้น',
        't1-s1-prefix' => 'คำนำหน้าชื่อ',
        't1-s2-firstName' => 'ชื่อ',
        't1-s2-lastName' => 'นามสกุล',
        't1-s2-year' => 'ระดับชั้น',
        't1-s2-prefix' => 'คำนำหน้าชื่อ',
        't2-s1-firstName' => 'ชื่อ',
        't2-s1-lastName' => 'นามสกุล',
        't2-s1-year' => 'ระดับชั้น',
        't2-s1-prefix' => 'คำนำหน้าชื่อ',
        't2-s2-firstName' => 'ชื่อ',
        't2-s2-lastName' => 'นามสกุล',
        't2-s2-year' => 'ระดับชั้น',
        't2-s2-prefix' => 'คำนำหน้าชื่อ',
        'file' => 'เอกสาร'
    ],
